...
3. Note: some citations may have already been processed. These citations have the format `<Cite bibKey=\"KEY\" />`, as discussed in (6) below. You should ignore all of these citations.
