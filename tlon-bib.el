...
`non-ai') instead of processing the entry at point."
  (interactive)
...
(defun tlon-bib--batch-dispatch-from-command-p ()
  "Return non-nil when the calling command should hand off to the batch driver."
