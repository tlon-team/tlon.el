...
;;;###autoload
(defun tlon-fetch-and-set-abstract (&optional interactive-p)
...
point."
  ...
  (if (tlon-bib--should-dispatch-to-batch-p interactive-p)
    ...
    (tlon-fetch-and-set-abstract--single)))
...
(defun tlon-fetch-and-set-abstract--single ()
  "Fetch and set the abstract for the entry at point (single-entry path)."
