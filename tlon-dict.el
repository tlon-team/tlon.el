...
(defun tlon-reverso-get-synonyms ()
  ...
  (interactive)
  (let* ((code (tlon-get-language-in-file))
	 (_ (unless code (user-error "Cannot determine language for current file")))
	 (language (tlon-lookup tlon-languages-properties :name :code code))
