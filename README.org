...
=tlon-team/tlon.el=. It separates read-only triage, local fixes, and externally
visible closure, and requires explicit authorization before GitHub comments,
issue closure, or org archiving.
