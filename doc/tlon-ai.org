...
:PROPERTIES:
:CUSTOM_ID: h:tlon-ai-create-newsletter-issue
:END:
#+findex: tlon-ai-create-newsletter-issue
The command ~tlon-ai-create-newsletter-issue~ automates the drafting of a new newsletter issue.
...
7. The resulting newsletter draft is displayed in a new buffer, typically named ~*Boletín Borrador AI*~, in Markdown mode.
