...
#+vindex: tlon-ai-newsletter-model
+ ~tlon-ai-newsletter-model~ :: Model to use for creating newsletter issues with ~tlon-newsletter-create-issue~.
  #+begin_src emacs-lisp
  (setq tlon-ai-newsletter-model nil) ; Use default gptel model
  #+end_src
