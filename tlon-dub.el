...
(defconst tlon-dub-propagate-timestamps-prompt-template
  "You will be given two inputs:\n1. A srt transcript with timestamps generated by
WhisperX.\n2. A human-edited Markdown transcript of the same audio. This transcript is more accurate in terms of wording, but has no timestamps.\n\nYour task is to propagate the timestamps from the WhisperX srt file to the human-edited Markdown file.\n\nOutput the contents of a new Markdown file consisting of the the human-edited transcript with the timestamps of the srt file. \n\nWhisperX srt file:\n```json\n%s\n```\n\nHuman-edited Markdown file:\n```text\n%s\n```\nReturn only the contents of the new file, without any additional commentary."
