...
WhisperX.\n2. A human-edited Markdown transcript of the same audio. This
transcript is more accurate in terms of wording, but has no timestamps.\n\nYour
task is to propagate the timestamps from the WhisperX srt file to the
human-edited Markdown file.\nOutput a new file in Markdown with contents of the
the human-edited transcript but the timestamps of the srt file. \n\nWhisperX srt file:\n```json\n%s\n```\n\nHuman-edited
Markdown file:\n```text\n%s\n```"
