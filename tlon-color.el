...
;; TODO: do not hardcode the project; make it work with arbitrary websites.
(defvar tlon-color-palette-file
  (file-name-concat default-directory "tlon-color-palettes.el")
