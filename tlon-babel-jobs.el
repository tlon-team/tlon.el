...
(defun tlon-babel-jobs-create-record-for-job (&optional key)
...
(defun tlon-babel-jobs-create-heading-for-job (&optional key commit)
...
;;;###autoload
(defun tlon-babel-jobs-create-job ()
